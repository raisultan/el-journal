...
import {notificationConstants, openNotification} from '../../utils'
...
class LayoutContainer extends Component {
  ...
  render() {
    ...
    console.log('LAYOUT', schoolInfo, pending, error)
    ...
    return (
      ...
      >
        ...
        <Layout>
          {
            !pending && schoolInfo === undefined || error ? openNotification('Возникла ошибка!', error)
            : null
          }
